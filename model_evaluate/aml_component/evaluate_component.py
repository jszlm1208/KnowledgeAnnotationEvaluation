...
def build_parse_args():
    ...
    parser.add_argument('--aml', type=bool, default=True, help='run the script in AML or local')
...
def main(): 
    ...
    if args.aml is True:
        ...
        print("get id2query from raw files")
    else:
    ...
    print("labeled_file_path: {}".format(labeled_file_path))
    ...
    print('labeled data is ready, the number of data is {}'.format(len(raw_datasets)))
    print('Example of data output: {}'.format(data[0]))
    print('Example of raw_datasets: {}'.format(raw_datasets[0]))
